...
from fastapi_realworld.app.api.routes import authentication, comments, profiles, tags, users
from fastapi_realworld.app.api.routes.articles import api as articles
